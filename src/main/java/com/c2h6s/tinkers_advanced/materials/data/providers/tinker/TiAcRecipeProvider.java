...
import com.c2h6s.tinkers_advanced.materials.data.enums.EnumModifier;
...
public class TiAcRecipeProvider extends RecipeProvider implements ISmelteryRecipeHelper {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        tableNugget(TiAcMeItems.BISMUTH_INGOT.get(), TiAcMeItems.BISMUTH_NUGGET.get(), Ingredient.of(TiAcTagkeys.Items.BISMUTH_INGOT), Ingredient.of(TiAcTagkeys.Items.BISMUTH_NUGGET), consumer, folder);
        ...
        materialRecipe(TiAcMaterialIds.BISMUTHINITE, Ingredient.of(TiAcMeItems.BISMUTHINITE.get()), 1, 1, consumer, folder);
        ...
        tableNugget(TiAcMeItems.ANTIMONY_INGOT.get(), TiAcMeItems.ANTIMONY_NUGGET.get(), Ingredient.of(TiAcTagkeys.Items.ANTIMONY_INGOT), Ingredient.of(TiAcTagkeys.Items.ANTIMONY_NUGGET), consumer, folder);
        ...
        materialRecipe(TiAcMaterialIds.STIBNITE, Ingredient.of(TiAcMeItems.STIBNITE.get()), 1, 1, consumer, folder);
        folder = namedFolder("disintegrate_crystal");
        materialRecipe(TiAcMaterialIds.DISINTEGRATE_CRYSTAL, Ingredient.of(TiAcMeItems.DISINTEGRATE_CRYSTAL.get()), 1, 1, consumer, folder);
        folder = namedFolder("resonance_crystal");
        materialRecipe(TiAcMaterialIds.RESONANCE_CRYSTAL, Ingredient.of(TiAcMeItems.RESONANCE_CRYSTAL.get()), 1, 1, consumer, folder);
        folder = namedFolder("voltaic_crystal");
        materialRecipe(TiAcMaterialIds.VOLTAIC_CRYSTAL, Ingredient.of(TiAcMeItems.VOLTAIC_CRYSTAL.get()), 1, 1, consumer, folder);
        folder = namedFolder("blaze_netherite");
        meltMaterial(TiAcMeFluids.MOLTEN_BLAZE_NETHERITE.get(), 90, TiAcMaterialIds.BLAZE_NETHERITE, 1480, consumer, folder);
        melt1Ingot(TiAcMeFluids.MOLTEN_BLAZE_NETHERITE.get(), TiAcMeItems.BLAZE_NETHERITE.get(), 1480, consumer, folder);
        materialRecipe(TiAcMaterialIds.BLAZE_NETHERITE, Ingredient.of(TiAcMeItems.BLAZE_NETHERITE.get()), 1, 1, consumer, folder);
        ...
        materialRecipe(TiAcMaterialIds.IRIDIUM, Ingredient.of(TiAcMeItems.IRIDIUM_CHUNK.get()), 3, 1, consumer, folder);
        MeltingRecipeBuilder.melting(Ingredient.of(TiAcMeItems.IRIDIUM_CHUNK.get()), FluidOutput.fromTag(TiAcTagkeys.Fluids.MOLTEN_IRIDIUM, 30), 1375, 30).save(consumer, new ResourceLocation(folder + "_melting_chunk"));
        ItemCastingRecipeBuilder.tableRecipe(TiAcMeItems.IRIDIUM_CHUNK.get()).setCoolingTime(10).setFluid(TiAcTagkeys.Fluids.MOLTEN_IRIDIUM, 30).save(consumer, new ResourceLocation(folder + "_casting_chunk"));
        ...
        meltMaterial(TiAcMeFluids.MOLTEN_IRRADIUM.get(), 90, TiAcMaterialIds.Mekanism.IRRADIUM, 2750, conditional, folder);
        materialRecipe(TiAcMaterialIds.Mekanism.IRRADIUM, Ingredient.of(TiAcMeItems.IRRADIUM_INGOT.get()), 1, 1, conditional, folder);
        ...
        meltMaterial(TiAcMeFluids.MOLTEN_PROTOCITE.get(), 90, TiAcMaterialIds.Mekanism.PROTOCITE, 2750, conditional, folder);
        materialRecipe(TiAcMaterialIds.Mekanism.PROTOCITE, Ingredient.of(TiAcMeItems.PROTOCITE_PELLET.get()), 1, 1, conditional, folder);
...
//        melt1Ingot(TiAcMeFluids.MOLTEN_DENSIUM.get(), TiAcMeItems.DENSIUM_INGOT.get(), 1755, conditional, folder);
//        meltMaterial(TiAcMeFluids.MOLTEN_DENSIUM.get(), 90, TiAcMaterialIds.Mekanism.DENSIUM, 1755, conditional, folder);
//        materialRecipe(TiAcMaterialIds.Mekanism.DENSIUM, Ingredient.of(TiAcMeItems.DENSIUM_INGOT.get()), 1, 1, conditional, folder);
//        AlloyRecipeBuilder.alloy(FluidOutput.fromStack(new FluidStack(TiAcMeFluids.MOLTEN_DENSIUM.get(), 90)), 1755)
//                .addInput(TiAcMeFluids.MOLTEN_IRIDIUM.get(), 90)
...
//                .save(conditional, new ResourceLocation(folder + "_alloy"));
        ...
        meltMaterial(TiAcMeFluids.MOLTEN_OSGLOGLAS.get(), 90, TiAcMaterialIds.Mekanism.OSGLOGLAS, 1755, conditional, folder);
        materialRecipe(TiAcMaterialIds.Mekanism.OSGLOGLAS, Ingredient.of(TiAcMeItems.OSGLOGLAS_INGOT.get()), 1, 1, conditional, folder);
        ...
        meltMaterial(TiAcMeFluids.MOLTEN_NUTRITIVE_SLIMESTEEL.get(), 90, TiAcMaterialIds.Mekanism.NUTRITIVE_SLIMESTEEL, 990, conditional, folder);
        materialRecipe(TiAcMaterialIds.Mekanism.NUTRITIVE_SLIMESTEEL, Ingredient.of(TiAcMeItems.NUTRITION_SLIME_INGOT.get()), 1, 1, conditional, folder);
        ...
        meltMaterial(TiAcMeFluids.MOLTEN_NEUTRONITE.get(), 90, TiAcMaterialIds.Mekanism.NEUTRONITE, 16384, conditional, folder);
        ...
        materialRecipe(TiAcMaterialIds.Mekanism.NEUTRONITE, Ingredient.of(TiAcMeItems.NEUTRONITE_INGOT.get()), 90, 1, conditional, folder);
        //PnC
        conditional = withCondition(consumer, modLoaded("pneumaticcraft"));
        folder = namedFolder("pneumatic_steel");
        materialRecipe(TiAcMaterialIds.PnC.PNEUMATIC_STEEL, Ingredient.of(TiAcMeItems.PNEUMATIC_STEEL.get()), 1, 1, conditional, folder);
        ...
        materialRecipe(TiAcMaterialIds.Thermal.BASALZ_SIGNALUM, Ingredient.of(TiAcMeItems.BASALZ_SIGNALUM.get()), 1, 1, conditional, folder);
        melt1Ingot(TiAcMeFluids.MOLTEN_BASALZ_SIGNALUM.get(), TiAcMeItems.BASALZ_SIGNALUM.get(), 995, conditional, folder);
        meltMaterial(TiAcMeFluids.MOLTEN_BASALZ_SIGNALUM.get(), 90, TiAcMaterialIds.Thermal.BASALZ_SIGNALUM, 995, conditional, folder);
        folder = namedFolder("blitz_lumium");
        materialRecipe(TiAcMaterialIds.Thermal.BLITZ_LUMIUM, Ingredient.of(TiAcMeItems.BLITZ_LUMIUM.get()), 1, 1, conditional, folder);
        cast1Ingot(TiAcMeFluids.MOLTEN_BILTZ_LUMIUM.get(), TiAcMeItems.BLITZ_LUMIUM.get(), 995, conditional, folder);
        meltMaterial(TiAcMeFluids.MOLTEN_BILTZ_LUMIUM.get(), 90, TiAcMaterialIds.Thermal.BLITZ_LUMIUM, 995, conditional, folder);
        ...
        materialRecipe(TiAcMaterialIds.Thermal.BLIZZ_ENDERIUM, Ingredient.of(TiAcMeItems.BLIZZ_ENDERIUM.get()), 1, 1, conditional, folder);
        melt1Ingot(TiAcMeFluids.MOLTEN_BLIZZ_ENDERIUM.get(), TiAcMeItems.BLIZZ_ENDERIUM.get(), 1640, conditional, folder);
        meltMaterial(TiAcMeFluids.MOLTEN_BLIZZ_ENDERIUM.get(), 90, TiAcMaterialIds.Thermal.BLIZZ_ENDERIUM, 1640, conditional, folder);
        folder = namedFolder("activated_chromatic_steel");
        materialRecipe(TiAcMaterialIds.Thermal.ACTIVATED_CHROMATIC_STEEL, Ingredient.of(TiAcMeItems.ACTIVATED_CHROMATIC_STEEL.get()), 1, 1, conditional, folder);
        ...
        meltMaterial(TiAcMeFluids.MOLTEN_ACTIVATED_CHROMATIC_STEEL.get(), 90, TiAcMaterialIds.Thermal.ACTIVATED_CHROMATIC_STEEL, 2720, conditional, folder);
        ...
        meltMaterial(TiAcMeFluids.MOLTEN_PINK_SLIME.get(), 90, TiAcMaterialIds.IndustrialForgoing.PINK_SLIME_METAL, 980, conditional, folder);
