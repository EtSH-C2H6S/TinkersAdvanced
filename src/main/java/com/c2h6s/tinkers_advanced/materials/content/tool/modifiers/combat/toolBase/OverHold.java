...
public class OverHold extends FluidDisplayBaseModifier implements ToolStatsModifierHook {
    ...
    public void addToolStats(IToolContext context, ModifierEntry modifier, ModifierStatsBuilder builder) {
        ...
        EtSTLibToolStat.RANGE.update(builder,(float)(double)TiAcConfig.COMMON.MATTER_MANIPULATOR_BASE_RANGE.get());
        EtSTLibToolStat.FLUID_EFFICIENCY.update(builder,(float)(double)TiAcConfig.COMMON.MATTER_MANIPULATOR_FLUID_EFFICIENCY.get());
    }
}
