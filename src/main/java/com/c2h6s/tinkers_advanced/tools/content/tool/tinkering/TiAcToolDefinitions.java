package com.c2h6s.tinkers_advanced.tools.content.tool.tinkering;
...
public class TiAcToolDefinitions {
    ...
    public static final ToolDefinition ELECTRON_TUNER = ToolDefinition.create(TiAcItems.ELECTRON_TUNER);
}
